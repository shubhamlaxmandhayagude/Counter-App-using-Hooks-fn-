...
const App =()=>{
    ...
    return(
        <div id="maindiv">
            <h1 id="h1">{count}</h1>
            <div>
                <button onClick={hamdleIncriment} className="button">+</button>
                <button onClick={hamdleDecriment} className="button">-</button>
                <button onClick={hamdleReset} className="button">Reset</button>
            </div>
        </div>
    )
}
